...
// // Colocando tipo igual juntos 
// const ordemAlfebeticatipo = (pokemons.map((pokemon) => pokemon.tipo).sort());

// console.log(ordemAlfebeticatipo);


// //  resultado = pokemons.forEach( item => {
// //      item.tipo === ""
// //  })

//   let numerodefalsos = 0;
//   const resultado = pokemonordemAlfebeticatipos.filter((item, index , array ) => { 
       
//   })

//  const arrayFind = ordemAlfebeticatipo.find( )
